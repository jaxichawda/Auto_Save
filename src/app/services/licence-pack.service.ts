...
export class LicencePackService {
 ...
 add(licensepackEntity){ 
  ...
  addTempData(licensepackEntity){ 
    debugger
   let promise = new Promise((resolve, reject) => {
     this.http.post(this.globals.baseAPIUrl + 'Licence_Pack/addTempData', licensepackEntity)
       .toPromise()
       .then(
         res => { // Success
           resolve(res);
 ...
 getAll(){ 
  ...
  getTempData(){ 
    debugger
   let promise = new Promise((resolve, reject) => {
     this.http.get(this.globals.baseAPIUrl + 'Licence_Pack/getTempData')
       .toPromise()
       .then(
         res => { // Success
           resolve(res);
  ...
  getTempById(licensepackId){
    let promise = new Promise((resolve, reject) => {
      this.http.get(this.globals.baseAPIUrl + 'Licence_Pack/getTempById/' + licensepackId)
        .toPromise()
        .then(
          res => { // Success
            resolve(res);
